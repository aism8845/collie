...
[Executioner]
  ...
  petsc_options = '-snes_monitor -ksp_monitor -snes_converged_reason -ksp_converged_reason -snes_test_jacobian'
...
[Outputs]
  ...
  [mesh_watch]
    type = CSV
    file_base = outputs/bath_smoke_mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/bath_smoke_solver_watch
    execute_on = 'TIMESTEP_END'

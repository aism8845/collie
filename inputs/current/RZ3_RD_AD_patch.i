...
[Outputs]
  ...
  [solver_watch]
    ...
    execute_on = 'TIMESTEP_END'
    show = 'dt nonlinear_its linear_its J_min_1 metric2_min_1 mesh_distortion_warning avg_J vol_change_pct avg_phi_cell max_phi_cell n_min n_max n_span avg_Dphys min_Dphys avg_Dref min_Dref D_ref_phys_ratio avg_gate_tot min_gate_tot max_gate_tot avg_gp avg_press avg_fa avg_ke avg_kh avg_eta'
  []
[]

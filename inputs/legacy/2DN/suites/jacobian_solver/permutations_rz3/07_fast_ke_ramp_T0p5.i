...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/jacobian_solver/permutations_rz3/07_fast_ke_ramp_T0p5/07_fast_ke_ramp_T0p5

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/07_fast_ke_ramp_T0p5/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/07_fast_ke_ramp_T0p5/solver_watch
    execute_on = 'TIMESTEP_END'

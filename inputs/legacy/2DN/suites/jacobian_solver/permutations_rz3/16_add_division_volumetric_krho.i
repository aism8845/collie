...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/jacobian_solver/permutations_rz3/16_add_division_volumetric_krho/16_add_division_volumetric_krho

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/16_add_division_volumetric_krho/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/16_add_division_volumetric_krho/solver_watch
    execute_on = 'TIMESTEP_END'

...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/jacobian_solver/permutations_rz3/12_D0_0p5_perc_phi0p65_m4/12_D0_0p5_perc_phi0p65_m4

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/12_D0_0p5_perc_phi0p65_m4/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/12_D0_0p5_perc_phi0p65_m4/solver_watch
    execute_on = 'TIMESTEP_END'

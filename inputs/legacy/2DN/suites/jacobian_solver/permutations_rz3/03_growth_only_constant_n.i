...
[Kernels]
  active = 'u_n_offdiag_x u_n_offdiag_y n_td'
  [u_n_offdiag_x]
...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/jacobian_solver/permutations_rz3/03_growth_only_constant_n/03_growth_only_constant_n

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/03_growth_only_constant_n/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/03_growth_only_constant_n/solver_watch
    execute_on = 'TIMESTEP_END'

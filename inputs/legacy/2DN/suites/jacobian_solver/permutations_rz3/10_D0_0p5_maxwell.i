...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/jacobian_solver/permutations_rz3/10_D0_0p5_maxwell/10_D0_0p5_maxwell

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/10_D0_0p5_maxwell/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/10_D0_0p5_maxwell/solver_watch
    execute_on = 'TIMESTEP_END'

...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/10_periodic_refresh_boundary/10_periodic_refresh_boundary

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/10_periodic_refresh_boundary/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/10_periodic_refresh_boundary/solver_watch
    execute_on = 'TIMESTEP_END'

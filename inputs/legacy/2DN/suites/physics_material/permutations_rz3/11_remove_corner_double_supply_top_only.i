...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/11_remove_corner_double_supply_top_only/11_remove_corner_double_supply_top_only

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/11_remove_corner_double_supply_top_only/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/11_remove_corner_double_supply_top_only/solver_watch
    execute_on = 'TIMESTEP_END'

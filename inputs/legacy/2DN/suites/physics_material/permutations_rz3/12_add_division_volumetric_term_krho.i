...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/12_add_division_volumetric_term_krho/12_add_division_volumetric_term_krho

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/12_add_division_volumetric_term_krho/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/12_add_division_volumetric_term_krho/solver_watch
    execute_on = 'TIMESTEP_END'

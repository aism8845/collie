...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/03_D0_0p5_perc_phi0p65_m4/03_D0_0p5_perc_phi0p65_m4

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/03_D0_0p5_perc_phi0p65_m4/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/03_D0_0p5_perc_phi0p65_m4/solver_watch
    execute_on = 'TIMESTEP_END'

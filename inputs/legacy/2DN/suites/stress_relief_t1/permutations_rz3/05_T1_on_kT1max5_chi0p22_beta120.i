...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/stress_relief_t1/permutations_rz3/05_T1_on_kT1max5_chi0p22_beta120/05_T1_on_kT1max5_chi0p22_beta120

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/stress_relief_t1/permutations_rz3/05_T1_on_kT1max5_chi0p22_beta120/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/stress_relief_t1/permutations_rz3/05_T1_on_kT1max5_chi0p22_beta120/solver_watch
    execute_on = 'TIMESTEP_END'

...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/jacobian_solver/permutations_rz3/06_slow_ke_ramp_T10/06_slow_ke_ramp_T10

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/06_slow_ke_ramp_T10/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/06_slow_ke_ramp_T10/solver_watch
    execute_on = 'TIMESTEP_END'

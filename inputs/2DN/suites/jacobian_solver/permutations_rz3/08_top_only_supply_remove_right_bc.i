...
[BCs]
  active = 'ux_axis uy_bottom n_top'
...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/jacobian_solver/permutations_rz3/08_top_only_supply_remove_right_bc/08_top_only_supply_remove_right_bc

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/08_top_only_supply_remove_right_bc/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/08_top_only_supply_remove_right_bc/solver_watch
    execute_on = 'TIMESTEP_END'

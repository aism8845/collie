# -----------------------------------------------------------------------------
# NOTE (case 17): nutrient_tl block is retained because kernels consume
# J_nutr, Jdot_nutr, D_eff_nutr, and n_source_ref_nutr directly.
...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/jacobian_solver/permutations_rz3/17_remove_redundant_nutrient_block/17_remove_redundant_nutrient_block

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/17_remove_redundant_nutrient_block/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/17_remove_redundant_nutrient_block/solver_watch
    execute_on = 'TIMESTEP_END'

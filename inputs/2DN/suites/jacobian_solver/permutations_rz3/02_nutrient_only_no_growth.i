...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/jacobian_solver/permutations_rz3/02_nutrient_only_no_growth/02_nutrient_only_no_growth

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/02_nutrient_only_no_growth/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/jacobian_solver/permutations_rz3/02_nutrient_only_no_growth/solver_watch
    execute_on = 'TIMESTEP_END'

...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/stress_relief_t1/permutations_rz3/04_press_str_x2/04_press_str_x2

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/stress_relief_t1/permutations_rz3/04_press_str_x2/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/stress_relief_t1/permutations_rz3/04_press_str_x2/solver_watch
    execute_on = 'TIMESTEP_END'

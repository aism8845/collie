...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/stress_relief_t1/permutations_rz3/02_gp_to_ke_LAGGED_filter_tau0p5h/02_gp_to_ke_LAGGED_filter_tau0p5h

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/stress_relief_t1/permutations_rz3/02_gp_to_ke_LAGGED_filter_tau0p5h/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/stress_relief_t1/permutations_rz3/02_gp_to_ke_LAGGED_filter_tau0p5h/solver_watch
    execute_on = 'TIMESTEP_END'

...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/01_D0_0p5_maxwell/01_D0_0p5_maxwell

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/01_D0_0p5_maxwell/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/01_D0_0p5_maxwell/solver_watch
    execute_on = 'TIMESTEP_END'

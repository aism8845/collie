...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/06_no_pressure_gate_on_ke/06_no_pressure_gate_on_ke

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/06_no_pressure_gate_on_ke/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/06_no_pressure_gate_on_ke/solver_watch
    execute_on = 'TIMESTEP_END'

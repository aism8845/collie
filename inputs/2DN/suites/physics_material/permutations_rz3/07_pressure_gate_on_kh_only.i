...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/07_pressure_gate_on_kh_only/07_pressure_gate_on_kh_only

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/07_pressure_gate_on_kh_only/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/07_pressure_gate_on_kh_only/solver_watch
    execute_on = 'TIMESTEP_END'

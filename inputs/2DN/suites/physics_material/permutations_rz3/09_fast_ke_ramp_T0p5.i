...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/09_fast_ke_ramp_T0p5/09_fast_ke_ramp_T0p5

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/09_fast_ke_ramp_T0p5/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/09_fast_ke_ramp_T0p5/solver_watch
    execute_on = 'TIMESTEP_END'

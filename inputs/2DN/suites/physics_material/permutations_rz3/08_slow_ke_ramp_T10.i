...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/08_slow_ke_ramp_T10/08_slow_ke_ramp_T10

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/08_slow_ke_ramp_T10/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/08_slow_ke_ramp_T10/solver_watch
    execute_on = 'TIMESTEP_END'

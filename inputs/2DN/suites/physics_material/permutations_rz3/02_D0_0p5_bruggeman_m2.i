...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/02_D0_0p5_bruggeman_m2/02_D0_0p5_bruggeman_m2

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/02_D0_0p5_bruggeman_m2/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/02_D0_0p5_bruggeman_m2/solver_watch
    execute_on = 'TIMESTEP_END'

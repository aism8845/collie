...
[Outputs]
  exodus = true
  perf_graph = true
  file_base = outputs/suites/physics_material/permutations_rz3/00_baseline/00_baseline

  [mesh_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/00_baseline/mesh_watch
    execute_on = 'TIMESTEP_END'
  ...
  [solver_watch]
    type = CSV
    file_base = outputs/suites/physics_material/permutations_rz3/00_baseline/solver_watch
    execute_on = 'TIMESTEP_END'
